...
- Creating a Comment or reply requires a browser-local Device Profile with a display name and syntactically valid email. Both remain unverified; the email requirement does not prove ownership or Participant identity. Notion-authored Comments are shown as “Product Team,” resolved Comments are hidden, and Participant email is never placed in Comment content or public responses.
