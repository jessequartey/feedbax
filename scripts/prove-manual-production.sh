...
step "Create an internal integration for the proof with Insert content capability."
...
step "Complete the browser, mobile-width, and keyboard smoke cycle in docs/manual-production-proof.md."
...
step "Complete the evidence checklist in docs/manual-production-proof.md."
