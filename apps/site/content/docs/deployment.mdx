...
**Planned for v0.1.0:** verified production builds for the complete portal on Cloudflare, Vercel, and Docker. Netlify is **Deferred** until those targets are dependable.
